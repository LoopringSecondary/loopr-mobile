...
class DefaultWebViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // view.backgroundColor = UIColor.init(rgba: "#000")
    ...
    func setupSafariButton() {
        let safariButton = UIButton(type: UIButton.ButtonType.custom)
        ...
        safariButton.addTarget(self, action: #selector(pressedSafariButton(_:)), for: UIControl.Event.touchUpInside)
